...
import { A as ApplicationLogo } from "./ApplicationLogo-DRETeZBQ.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-100", children: [
    /* @__PURE__ */ jsxs("nav", { className: "bg-white border-b border-gray-100", children: [
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between h-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden space-x-8 sm:-my-px sm:ms-10 sm:flex", children: [
            ...
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("cartography"),
                active: route().current("cartography"),
            ...
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("intelectual"),
                active: route().current("intelectual"),
                children: "Intelectual"
              }
            ),
            /* @__PURE__ */ jsx(
              NavLink,
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden sm:flex sm:items-center sm:ms-6", children: user ? /* @__PURE__ */ jsx("div", { className: "ms-3 relative", children: /* @__PURE__ */ jsxs(Dropdown$1, { children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href: route("login"),
              className: "font-semibold dark:text-gray-600 dark:hover:text-gray-900 text-gray-400 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500",
              children: "Log in"
            }
          ),
          /* @__PURE__ */ jsx(
            ...
            {
              href: route("register"),
              class: "font-semibold dark:text-gray-600 dark:hover:text-gray-900 text-gray-400 =hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500",
              children: "Register"
            }
          )
        ] }) }),
      ...
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            user ? /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "pt-4 pb-1 border-t border-gray-200", children: [
            ...
            ] }) }) : /* @__PURE__ */ jsxs("div", { className: "grid gap-3 items-center", children: [
              /* @__PURE__ */ jsx(
                "a",
                {
                  href: route("login"),
                  className: "w-full flex items-start ps-3 pe-4 py-2 border-l-4 font-semibold dark:text-gray-600 dark:hover:text-gray-900 text-gray-400 hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500",
                  children: "Log in"
                }
              ),
              /* @__PURE__ */ jsx(
                ...
                {
                  href: route("register"),
                  class: "w-full flex items-start ps-3 pe-4 py-2 border-l-4 font-semibold dark:text-gray-600 dark:hover:text-gray-900 text-gray-400 =hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500",
                  children: "Register"
                }
              )
            ] })
