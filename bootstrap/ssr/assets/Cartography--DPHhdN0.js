    ...
    Authenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-6", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "px-6 text-xl", children: [
            "Вибрана позиція: ",
            position[0],
            ", ",
            position[1]
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-6 max-md:aspect-square md:h-[40rem] w-full overflow-hidden", children: /* @__PURE__ */ jsxs(
            MapContainer,
            {
              center: position,
              zoom: 17,
